...
import {registerClinicalCenterAdmin} from '../../actions/auth';

import LocationDialog from '../Location/LocationDialog';

class AddClinicalCenterAdmin extends Component{
    constructor(props) {
        super(props);
        this.state = {
            name: '',
    ...
    handleOnSubmit = (e) => {
        ...
        this.props.registerClinicalCenterAdmin(datas);
            ...
            <MDBContainer>
                <MDBModal isOpen={ this.props.show } toggle={this.props.toggle}>
                    <MDBModalHeader toggle={this.props.toggle}>
                        <div className="text-center">
                            Register clinical center admin
                        </div> 
                    </MDBModalHeader>
                    <MDBModalBody>
...
export default connect(mapStateToProps, { registerClinicalCenterAdmin })(AddClinicalCenterAdmin);